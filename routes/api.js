...
router.post('/beer', function (req, res, next) {
  var beer = new _Beer2.default(req.body.name, req.body.IBU, req.body.SRM, req.body.ABV, req.body.beerOrganolepticDescription, req.body.stock, req.body.breweryName, req.body.beerID, req.body.tapID, req.body.beerFantasyName);
